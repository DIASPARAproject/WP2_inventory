...
libs <- c("tools", "tidyverse", "icesTAF", "stringr", "flextable", "ggplot2", "viridis", "purrr", "quantreg", "RColorBrewer") 
...
folder_path <- "data/issues/data_call_base_response"
...
save(all_odd, all_odd_validated, all_odd_unvalidated, all_odd_unvalidated_relevant, file = "data/issues/odd_data.RData")
