...
#load data
load("../../initial/data/biometry_sampling.RData") 
biometry_individual_sampling <- biometry_individual_sampling %>% mutate(source = "sampling")
load("../../initial/data/biometry_series.RData")
...
individual_wide <- individual_raw %>% 
...
#save as RData
save(individual_wide, file = "individual_wide.RData")
